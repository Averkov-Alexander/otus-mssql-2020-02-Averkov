...
-- дл€ корректной работы примера необходимо ниже по тексту заменить:
--а) им€ файла в который будут выгружены данные на своЄ:
--C:\Program Files\Microsoft SQL Server\MSSQL13.SQLEXPRESS\MSSQL\Backup\Customers.txt
--б) им€ сервера на своЄ
...
SELECT * INTO Customers_Copy FROM Sales.Customers WHERE 0=1; --создаЄм копию таблицы
